              ...
              users.map((user) => (
                ...
                >
                  <div className="flex justify-between items-start gap-2">
                    ...
                    {user.isActive ? (
                      <span className="px-2 py-1 bg-green-100 text-green-800 rounded-full text-xs font-semibold whitespace-nowrap shrink-0">
                        Active
                      </span>
                    ) : (
                      <span className="px-2 py-1 bg-red-100 text-red-800 rounded-full text-xs font-semibold whitespace-nowrap shrink-0">
                        Inactive
                      </span>
                    )}
                  </div>
                  ...
                  <div className="grid grid-cols-2 gap-2 text-sm">
                    ...
                    <div className="bg-white p-3 rounded border border-gray-200">
                      ...
                      <p className="text-sm text-gray-700 mt-1">{user.department || "-"}</p>
                    </div>
                  </div>
                  ...
                  <div className="flex gap-2 pt-2">
                    <button
                      onClick={() => openEditModal(user)}
                      className="flex-1 bg-blue-100 hover:bg-blue-200 text-blue-700 px-3 py-2 rounded font-semibold transition text-sm"
                    >
                      Edit
                    </button>
                    <button
