        ...
        <div className="bg-gray-50 p-6 rounded-lg mb-6">
          ...
          <form onSubmit={handleCreateProject} className="space-y-4">
            ...
            <div className="flex gap-3">
              <button
                type="submit"
                className="flex-1 h-11 px-4 bg-emerald-600 text-white rounded-lg font-semibold hover:bg-emerald-700 transition shadow-sm"
              >
                Create
              </button>
              <button
                ...
                className="flex-1 h-11 px-4 bg-white border border-gray-300 text-gray-800 rounded-lg font-semibold hover:bg-gray-100 transition"
              >
                Cancel
              </button>
            </div>
